      ...
      {amenities.map((a) => {
        ...
        return (
          <button
            ...
            className={`group inline-flex items-center gap-2 rounded-xl border px-4 py-2 text-sm whitespace-nowrap max-w-62.5 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${isSelected ? "border-indigo-500 bg-indigo-50 text-indigo-700 shadow-sm" : "border-slate-200 bg-white hover:border-slate-300 hover:bg-slate-50"}`}
          >
            {Icon && (
              <Icon
                size={iconSize}
