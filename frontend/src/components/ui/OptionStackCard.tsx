...
export const OptionStackCard = ({ option, onBook, isBooking, formatPrice }: OptionStackCardProps) => {
  return (
    <article className="flex flex-col md:flex-row md:items-center md:gap-8 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-indigo-200 hover:shadow-md">
      ...
      <div className="mt-6 md:mt-0 md:w-80 md:pl-6 md:border-l md:border-slate-100">
